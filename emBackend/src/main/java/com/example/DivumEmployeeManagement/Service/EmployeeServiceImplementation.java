...
//get
    ...
    @Override
    public String getbyid(String email) {
        boolean emp = employeeRepository.existsById(email);
        System.out.println(employeeRepository.existsById(email));
        return Boolean.toString(emp);
    }
}
